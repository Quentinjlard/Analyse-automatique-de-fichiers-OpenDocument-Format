...
public class AnalyseContent {
    ...
    public String RetourFinal() {
        ...
        int nbSlides = NombreSlides();
        String retour = "Il y a " + nbSlides + " slides. Il y a un tableau : " + Tableau + " Les numéros de slides sont affichés " + NumeroPages + " Il y a une animation : " + Animations;
        return retour;
    }
}
