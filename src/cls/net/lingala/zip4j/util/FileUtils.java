...
import cls.net.lingala.zip4j.model.ExcludeFileFilter;
...
import static cls.net.lingala.zip4j.util.InternalZipConstants.FILE_SEPARATOR;
import static cls.net.lingala.zip4j.util.InternalZipConstants.ZIP_FILE_SEPARATOR;
