...
import cls.net.lingala.zip4j.model.enums.CompressionLevel;
...
import static cls.net.lingala.zip4j.util.BitUtils.setBit;
import static cls.net.lingala.zip4j.util.BitUtils.unsetBit;
import static cls.net.lingala.zip4j.util.FileUtils.isZipEntryDirectory;
import static cls.net.lingala.zip4j.util.ZipVersionUtils.determineVersionMadeBy;
import static cls.net.lingala.zip4j.util.ZipVersionUtils.determineVersionNeededToExtract;
